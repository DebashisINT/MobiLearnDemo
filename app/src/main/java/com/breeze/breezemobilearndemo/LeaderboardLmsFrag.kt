...
class LeaderboardLmsFrag : Fragment(), View.OnClickListener {
    ...
    private var isOverallOwnSelected:Boolean = true
    ...
    private fun initView(view: View) {
        ...
        progress_wheel_frag_ldr_lms=view.findViewById(R.id.progress_wheel)
    ...
    private fun showPopup(view: View, needscore: Int, userTotalScore: Int) {
        ...
        popup_title.setText("Congratulation ")
                ...
                Handler().postDelayed(Runnable {
                    if(respBranchData.status == NetworkConstant.SUCCESS){
                        ...
                        if(mFilterbranchData.size>0){
                            ...
                            Toast.makeText(mContext, "No Branch Found", Toast.LENGTH_SHORT).show()
                        }
                    }
                    else{
                        Toast.makeText(mContext, getString(R.string.something_went_wrong), Toast.LENGTH_SHORT).show()
    ...
    private fun getSubBranchList(tv_subBranch: TextView, subBranch_list: ArrayList<SubBranchData>) {
        ...
        val et_subBranchNameSearch =
            subBranchDialog.findViewById(R.id.et_dialog_subBranch_search) as AppCompatEditText
    ...
    private fun showNoDataDialog() {
        ...
        val dialogHeader = simpleDialog.findViewById(R.id.dialog_cancel_order_header_TV) as AppCompatTextView
        dialogHeader.text = mContext.applicationContext.getString(R.string.branch_select)
        val dialog_yes_no_headerTV = simpleDialog.findViewById(R.id.dialog_yes_no_headerTV) as AppCompatTextView
    ...
    private fun setToolbar() {
        if (!ownclick) {
            ...
            (mContext as DashboardActivity).toolbarTitle.text = "Learners Leaderboard (Me)"
        }
    }
}